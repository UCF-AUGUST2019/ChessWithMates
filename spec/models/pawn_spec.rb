...
RSpec.describe Pawn, type: :model do
  ...
  #   piece1 = Pawn.create(game_id: 1, player_id: 1, x_pos: 4, y_pos: 4, color: 'Black', has_moved: false)
  ...
  #   piece2 = Pawn.create(game_id: 1, player_id: 2, x_pos: 3, y_pos: 1, color: 'White', has_moved: true, captured: false)
  #   expect(piece1.move(4, 2)).to eq(true)
  # end
  # it 'checks if the entered move is moving backwards and returns invalid' do
  #   piece1 = Pawn.create(game_id: 1, player_id: 1, x_pos: 4, y_pos: 4, color: 'Black')
