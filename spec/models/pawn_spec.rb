...
RSpec.describe Pawn, type: :model do
  ...
  it 'checks if the entered move is valid and the first move, then moves the pawn 2 spaces' do
    ...
    game1 = FactoryBot.create(:game, white_id: 1, turn: 1)
    FactoryBot.create(:piece, game: game1, color: 'White', player_id: 1, type: 'Pawn')
    piece1 = Piece.where(game: game1, color: 'White', player_id: 1, type: 'Pawn').first
